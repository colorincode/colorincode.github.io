...
Have all code meeting 60-80% of code standards.
...
- **Main Goals**  
        ...
        [4] Don't be a know it all smarty pants. 
        We are all smart, offer alternative implementations, but assume the author already considered them. 
